...
def create(client, resource_group_name, account_name, location, sku_name, tags=None, custom_headers=None, raw=False):
    ...
    sku = Sku(sku_name)
    lbs_account_create_params = LocationBasedServicesAccountCreateParameters(location, sku, tags)
